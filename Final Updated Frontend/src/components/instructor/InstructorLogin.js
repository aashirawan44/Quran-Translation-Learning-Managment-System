...
import { loginInstructor } from '../../redux/actions/auth';
import PropTypes from 'prop-types';
import { useState } from "react";

const InstructorLogin = ({ loginInstructor, isAuthenticated }) => {
...
loginInstructor.propTypes = {
  ...
  export default connect(mapStateToProps, { loginInstructor })(InstructorLogin);