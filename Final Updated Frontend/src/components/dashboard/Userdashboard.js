...
import { getCurrentProfileUser, deleteAccount } from '../../redux/actions/profile';
      ...
      {profile !== null && profile != undefined ? (
        <>
          ...
          <div className='flex flex-col justify-center items-center gap-4'>
            ...
            {profile && <DashboardTop profile={profile} />}

              {/* <ProfileAbout profile={profile}/> */}
            </div>
            <div className='flex flex-col w-full lg:w-1/2 border rounded-md'>              {/* <Education education={profile.education} /> */}
              {profile && <ProfileEducation education={profile.education} />}
          ...
          {/* <div className="flex flex-col items-start gap-4 justify-center border-2 w-3/4 mb-4">
            ...
            <div className='w-11/12 ml-12 h-px bg-[#00A86B]'>
...
export default connect(mapStateToProps, { getCurrentProfileUser, deleteAccount })(
  Userdashboard
);
